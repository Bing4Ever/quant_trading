...
from ...core import IBroker, Order, TradingSignal
...
class RiskController:
        ...
        try:
            ...
            if signal.action.lower() == "buy":
                ...
                if total_cost > cash:
                    return (
                        False,
                        f"现金不足: 需要 ${total_cost:,.2f}, 可用 ${cash:,.2f}",
                    )
            ...
            if signal.action.lower() == "buy":
                ...
                total_position_value = (
                    sum(pos.market_value for pos in positions) + trade_value
                )
            ...
            if (
                self.daily_pnl < 0
                and daily_loss_ratio > self.risk_limits.max_daily_loss
            ):
                return False, (
    ...
    def get_risk_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            daily_loss_ratio = (
                abs(self.daily_pnl) / self.initial_equity
        ...
        try:
            ...
            for pos in positions:
                ...
                if position_ratio > self.risk_limits.max_position_size:
                    ...
                    # 可以考虑加仓
                    available_ratio = (
                        self.risk_limits.max_position_size - position_ratio
                    )
            ...
            if (
                ...
                > self.risk_limits.max_total_exposure * 0.9
            ):
                suggestions["warnings"].append(
                    {
                        "type": "exposure",
            ...
            return {"reduce_positions": [], "can_increase": [], "warnings": []}
