...
class MeanReversionStrategy(BaseStrategy):
    ...
    def generate_signals(self, data: pd.DataFrame) -> pd.DataFrame:
        ...
        self.signals = df[['close', 'bb_upper', 'bb_middle', 'bb_lower', 'rsi', 'signal', 'position']].copy()
        
        return df[['signal', 'position', 'bb_upper', 'bb_middle', 'bb_lower', 'rsi', 'signal_strength']]
    ...
    def add_volume_filter(self, data: pd.DataFrame, volume_ma_period: int = 20) -> pd.DataFrame:
        """
    ...
    def add_trend_filter(self, data: pd.DataFrame, trend_period: int = 50) -> pd.DataFrame:
        """
    ...
    def optimize_parameters(
        ...
        for bb_period in range(bb_period_range[0], bb_period_range[1] + 1, 2):
            for rsi_period in range(rsi_period_range[0], rsi_period_range[1] + 1, 2):
                for rsi_threshold in range(rsi_threshold_range[0], rsi_threshold_range[1] + 1, 5):
